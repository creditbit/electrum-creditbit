...
from electrum_creditbit import bitcoin, util
...
from electrum_creditbit_gui.qt import transaction_dialog
...
class Plugin(BasePlugin):
    ...
    def cosigner_can_sign(self, tx, cosigner_xpub):
        from electrum_creditbit.transaction import x_to_xpub
        xpub_set = set([])
