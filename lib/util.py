...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-creditbit")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-creditbit")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-creditbit")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-creditbit/"
    else:
...
block_explorer_info = {
    'explorer.creditbit.org': ('https://explorer.creditbit.org',
                        {'tx': 'tx', 'addr': 'address'}),
}

def block_explorer(config):
    return config.get('block_explorer', 'explorer.creditbit.org')
...
def create_URI(addr, amount, message):
    ...
    p = urlparse.ParseResult(scheme='creditbit', netloc='', path=addr, params='', query='&'.join(query), fragment='')
