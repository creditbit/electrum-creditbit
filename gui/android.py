...
from electrum_creditbit import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_creditbit.bitcoin import is_address
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-Creditbit"
...
def pay_to(recipient, amount, label):
    ...
    droid.dialogCreateSpinnerProgress("Electrum-Creditbit", "signing transaction...")
    droid.dialogShow()
        ...
        if event["name"] == "click":
            ...
            if id=="buttonPay":
                ...
                if r:
                    ...
                    if data:
                        print "data", data
                        if re.match('^creditbitcoin:', data):
...
def receive_loop():
    ...
    while out is None:
        ...
        if not event:
            ...
            amount = modal_input('Amount', 'Amount you want to receive (in CREDIT). ', format_satoshis(receive_amount) if receive_amount else None, "numberDecimal")
...
def make_bitmap(data):
    ...
    try:
        import qrcode
        from electrum_creditbit import bmp
        qr = qrcode.QRCode()
        qr.add_data(data)
...
class ElectrumGui:
    ...
    def __init__(self, config, _network):
        ...
        if not storage.file_exists:
            ...
            droid.dialogCreateSpinnerProgress("Electrum-Creditbit", msg)
            droid.dialogShow()
