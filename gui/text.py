...
_ = lambda x:x
#from i18n import _
from electrum_creditbit.util import format_satoshis, set_verbosity
from electrum_creditbit.util import StoreDict
from electrum_creditbit.bitcoin import is_valid

from electrum_creditbit import Wallet, WalletStorage
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            self.show_message(_('Invalid creditbitcoin address'))
            return
        try:
