...
from electrum_creditbit import ELECTRUM_VERSION, print_error
...
class VersionGetter(threading.Thread):
    ...
    def run(self):
        try:
            con = httplib.HTTPSConnection('www.creditbit.org', timeout=5)
...
class UpdateLabel(QLabel):
    ...
    def open_website(self):
        webbrowser.open("http://www.creditbit.org/")
        self.dialog.done(0)
