...
from electrum_creditbit.bitcoin import is_valid
...
import re
import time
from electrum_creditbit.wallet import Wallet, WalletStorage
import webbrowser
import history_widget_lite
import receiving_widget
from electrum_creditbit import util
import datetime

from electrum_creditbit.version import ELECTRUM_VERSION as electrum_version
from electrum_creditbit.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Creditbit address or contact"))
        ...
        self.setWindowTitle("Electrum-Creditbit")
    ...
    def the_website(self):
        webbrowser.open("http://electrum-creditbit.space")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Creditbit address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Creditbit payment"))
...
class MiniActuator:
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Electrum-Creditbit')
