...
from electrum_creditbit.i18n import _, set_language
from electrum_creditbit.util import block_explorer, block_explorer_info, block_explorer_URL
...
from electrum_creditbit.bitcoin import MIN_RELAY_TX_FEE, is_valid
from electrum_creditbit.plugins import run_hook

import icons_rc

from electrum_creditbit.util import format_satoshis, format_time, NotEnoughFunds, StoreDict
from electrum_creditbit import Transaction
from electrum_creditbit import mnemonic
from electrum_creditbit import util, bitcoin, commands, Wallet
from electrum_creditbit import SimpleConfig, Wallet, WalletStorage
from electrum_creditbit import Imported_Wallet
...
from electrum_creditbit import ELECTRUM_VERSION
import re
...
from electrum_creditbit.paymentrequest import PR_UNPAID, PR_PAID, PR_EXPIRED
from electrum_creditbit.paymentrequest import PaymentRequest, InvoiceStore, get_payment_request, make_payment_request
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-creditbit.png"))
        self.init_menubar()
    ...
    def load_wallet(self, wallet):
        import electrum_creditbit as electrum
        self.wallet = wallet
        ...
        title = 'Electrum-Creditbit %s  -  %s' % (self.wallet.electrum_version, self.wallet.basename())
    ...
    def init_menubar(self):
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://www.creditbit.org"))
        help_menu.addSeparator()
        help_menu.addAction(_("&Documentation"), lambda: webbrowser.open("http://docs.electrum.org/en/latest/")).setShortcut(QKeySequence.HelpContents)
        help_menu.addAction(_("&Report Bug"), self.show_report_bug)

        self.setMenuBar(menubar)

    def show_about(self):
        QMessageBox.about(self, "Electrum-creditbit",
            _("Version")+" %s" % (self.wallet.electrum_version) + "\n\n" + _("Electrum's focus is speed, with low resource usage and simplifying Creditbit. You do not need to perform regular backups, because your wallet can be recovered from a secret phrase that you can memorize or write on paper. Startup times are instant because it operates in conjunction with high-performance servers that handle the most complicated parts of the Creditbit system."))

    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-creditbit - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/creditbit/electrum-creditbit/issues\">https://github.com/creditbit/electrum-creditbit/issues</a>")
    ...
    def notify(self, message):
        if self.tray:
            self.tray.showMessage("Electrum-creditbit", message, QSystemTrayIcon.Information, 20000)
    ...
    def create_send_tab(self):
        ...
        msg = _('Recipient of the funds.') + '\n\n'\
              + _('You may enter a Creditbit address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a Creditbit address)')
        ...
        msg = _('Creditbit transactions are in general not free. A transaction fee is paid by the sender of the funds.') + '\n\n'\
    ...
    def read_send_tab(self):
        ...
        for _type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('Creditbit Address is None'), _('OK'))
                return
            if _type == 'address' and not bitcoin.is_address(addr):
                QMessageBox.warning(self, _('Error'), _('Invalid Creditbit Address'), _('OK'))
                return
            if amount is None:
    ...
    def pay_from_URI(self,URI):
        ...
        try:
            ...
            QMessageBox.warning(self, _('Error'), _('Invalid creditbit URI:') + '\n' + str(e), _('OK'))
            return
    ...
    def new_account_dialog(self, password):
        ...
        e = QLineEdit()
        vbox.addWidget(e)
        msg = _("Note: Newly created accounts are 'pending' until they receive creditbits.") + " " \
    ...
    def read_tx_from_qrcode(self):
        from electrum_creditbit import qrscanner
        try:
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-creditbit-private-keys.csv'
    ...
    def do_export_labels(self):
        ...
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum-creditbit_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
    ...
    def export_history_dialog(self):
        ...
        vbox = QVBoxLayout(d)
        defaultname = os.path.expanduser('~/electrum-creditbit-history.csv')
    ...
    def settings_dialog(self):
        ...
        from electrum_creditbit.i18n import languages
        ...
        def on_unit(x):
            ...
            if self.base_unit() == unit_result:
                return
            if unit_result == 'CREDIT':
                self.decimal_point = 8
            elif unit_result == 'mCREDIT':
    ...
    def plugins_dialog(self):
        from electrum_creditbit.plugins import plugins, descriptions, is_available, loader
    ...
    def create_csr(self, alias, challenge, password):
        from electrum_creditbit import x509
        import tlslite
