...
_ = lambda x:x
#from i18n import _
from electrum_creditbit.wallet import WalletStorage, Wallet
from electrum_creditbit.util import format_satoshis, set_verbosity, StoreDict
from electrum_creditbit.bitcoin import is_valid
from electrum_creditbit.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-creditbit create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Creditbit address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-creditbit setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-creditbit setconfig' to change your settings")
        return True
