...
from electrum_creditbit.util import print_error, InvalidPassword
from electrum_creditbit.bitcoin import is_valid
from electrum_creditbit import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-Creditbit"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_creditbit.util import format_satoshis, parse_URI
from electrum_creditbit.network import DEFAULT_SERVERS
from electrum_creditbit.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-Creditbit ' + self.wallet.electrum_version + '  -  ' + self.config.path
        ...
        from electrum_creditbit.util import StoreDict
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid creditbit address:\n"+to_address)
            return
