...
imp.load_module('electrum_creditbit', *imp.find_module('lib'))

from electrum_creditbit import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_creditbit import util
from electrum_creditbit.transaction import Transaction
from electrum_creditbit.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-Creditbit Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-creditbit/authenticator')
